...
def fats():
    ...
    white_bd_areas.append([])
    white_bd_areas.append(['total area', total_area])
    
    white_bd_areas_file = open(output_image_name + '_bdy.' + 'csv', 'w', newline='', encoding='utf16')
    csv_write1 = csv.writer(white_bd_areas_file, delimiter = ',')
    # store area values
    for i in white_bd_areas:
        csv_write1.writerow(i)
